<!-- Auto-generated by scripts/fetch-docs.ts from https://nextjs.org/docs/app/getting-started/route-handlers (Next.js 16.3.5, fetched 2026-09-15). Do not edit. -->

# Route Handlers

> Create custom request handlers with Next.js Route Handlers using the Web Request and Response APIs.
>
