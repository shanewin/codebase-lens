<!-- Auto-generated by scripts/fetch-docs.ts from https://nextjs.org/docs/app/guides/caching-without-cache-components (Next.js 16.3.5, fetched 2026-09-15). Do not edit. -->
...
To prerender dynamic routes with [`generateStaticParams`](https://nextjs.org/docs/app/api-reference/functions/generate-static-params) and revalidate them over time, see the [Incremental Static Regeneration](https://nextjs.org/docs/app/guides/incremental-static-regeneration) guide.
---
