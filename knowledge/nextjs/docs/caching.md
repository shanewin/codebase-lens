<!-- Auto-generated by scripts/fetch-docs.ts from https://nextjs.org/docs/app/getting-started/caching (Next.js 16.3.5, fetched 2026-09-15). Do not edit. -->
...
See [Adopting Partial Prefetching](https://nextjs.org/docs/app/guides/adopting-partial-prefetching) to understand how `<Link>` prefetching behaves and how to adopt it.
